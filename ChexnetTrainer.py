...
class ChexnetTrainer():
    ...
    def test(self,pathDirData, pathFileTest, pathModel, nnArchitecture, nnClassCount, nnIsTrained, trBatchSize, transResize, transCrop, launchTimeStamp):
        ...
        '''
        CLASS_NAMES = [ 'class_7', 'class_2','class_5','class_3','class_4','class_12','class_10',
                       'class_6', 'class_11','class_8','class_14','class_1','class_13','class_9']
        ...
        a = np.argmax(outPRED,axis=1)
        results= [CLASS_NAMES[i] for i in a]
        
        sub = pd.read_csv('sample_submission.csv')
        sub['detected']=results
